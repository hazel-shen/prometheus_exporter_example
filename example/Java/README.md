...
3. Visit the `/metrics` endpoint: [http://localhost:8080/q/metrics](http://localhost:8080/q/metrics)
...
> docker build -f ./src/main/docker/Dockerfile.jvm .  -t quay.io/hazel_shen/quarkus_exporter_example:v1
